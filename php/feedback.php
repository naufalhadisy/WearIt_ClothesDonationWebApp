...
if (isset($_POST['update'])) {
    ...
    header("Refresh:5");
    if ($query) {
        echo "<script>alert('You have successfully post the reply');</script>";
        echo "<script type='text/javascript'> document.location ='../php/feedback.php'; </script>";
    }
}
                ...
                ?>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <?php if ($rows["reply"] == NULL && isset($_SESSION['donor_email'])) { ?>
