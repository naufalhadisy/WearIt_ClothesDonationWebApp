...
if (isset($_POST['save'])) {
  ...
  $query4 = "SELECT Password FROM donor WHERE Email = '$account'";
  ...
  if ($data['Password'] == md5($password))
  {
      ...
      if ($newpassword1 == $newpassword2)
      {
          ...
          $query5 = "UPDATE donor SET Password = '$newencryptedpassword' WHERE Email = '$account' ";
          $result3 = mysqli_query($con, $query5);
          
          if ($result3) echo "<script>alert('Password Changed')</script>";
          echo "<script type='text/javascript'> document.location ='donor_profile.php'; </script>";
      }
